...
\title{Multi-order Egocentric Friendship Network and Its Betweenness}
...
\begin{keyword}
Egocentric Networks \sep Betweenness Centrality
...
An egocentric network (also called egocentric network) consists of the alters connected to ego, along with the links between
...
\input{multi-order-friendship-networks}
