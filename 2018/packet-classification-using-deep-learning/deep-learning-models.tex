...
As shown in Fig. \ref{fig3}, the model architecture of CNN is composed of the input layer, Convolution layer, and Pooling layer and Fully connected layer.
...
RNN is a network architecture that can accept inputs and outputs regardless of input data length and can be implemented variously and flexible as needed.
